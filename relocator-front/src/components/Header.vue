    ...
    <div class="bg-white shadow">
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-4">
          ...
          <div class="hidden sm:flex sm:items-center">
            <router-link to="/signin" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4 uppercase" v-if="!signedIn()">Sign in</router-link>
            <router-link to="/signup" class="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600 uppercase" v-if="!signedIn()">Sign Up</router-link>
          </div>
