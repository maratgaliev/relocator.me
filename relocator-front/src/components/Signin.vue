<template>
  <div class="max-w-sm m-auto my-8">
    <div class="border p-10 border-grey-light shadow rounded">
      <h3 class="text-2xl mb-6 text-grey uppercase text-center">Sign In</h3>
      <form @submit.prevent="signin">
        ...
        <div class="my-4"><router-link to="/signup" class="link-grey uppercase">Sign up</router-link></div>
      </form>
    </div>
  </div>
</template>
